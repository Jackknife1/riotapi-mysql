#Import libraries for reguesting api 
import requests


#Summoner name and region (can be inputed b user)
name = "FILDAS247" #input("What is your summoner name:? ")
...
api_key = "RGAPI-f83d4875-7e97-43d9-9fc4-5827ea181ddd"
...
#Formated API URL for list of games
...
gameid = last_match_data['info']['gameId']
queueid = last_match_data['info']['queueId']
participants = last_match_data['metadata']['participants']
gameduration = last_match_data['info']['gameDuration']
gametype = last_match_data['info']['gameType']
gamemode = last_match_data['info']['gameMode']
gamename = last_match_data['info']['gameName']
mapid = last_match_data['info']['mapId']
platformid = last_match_data['info']['platformId']
queueid = last_match_data['info']["queueId"]
...
#Tuple with players puuids
participants_puuids = (part1, part2, part3, part4, part5, part6, part7, part8, part9, part10)
...
part_dmg = {part1_n : part1_dmg, part2_n : part2_dmg, part3_n : part3_dmg, part4_n : part4_dmg, part5_n : part5_dmg, part6_n : part6_dmg, part7_n : part7_dmg, part8_n : part8_dmg, part9_n : part9_dmg, part10_n : part10_dmg}
...
#Math operations for all particiants KDA
...
kda_dict = {part1_n : part1_kda, part2_n : part2_kda, part3_n : part3_kda, part4_n : part4_kda, part5_n : part5_kda, part6_n : part6_kda, part7_n : part7_kda, part8_n : part8_kda, part9_n : part9_kda, part10_n : part10_kda}
...
#Function for getting kda mvp name and his kda value
...
#Function for getting damage mvp name and his damage value
...
#Checks if participants have same teamid as me and sorts into lists my team and my team champions
myteam_names = []
myteam_champions = []
...
#Formating gamemode arena to display "Arena"
if gamemode == "CHERRY":
    gamemode = "Arena"
...
firstblood = last_match_data['info']['participants'][part_index]['firstBloodKill']
...
dmg_buildings = last_match_data['info']['participants'][part_index]["damageDealtToBuildings"]
vision_score = last_match_data['info']['participants'][part_index]["visionScore"]
individual_position = last_match_data['info']['participants'][part_index]['individualPosition']
...
#Formating win to display string not boolean result
if win is True:
    win = 'Win'
else:
    win = "Lose"
...
final_list = (matchid, duration, queue_type, win,champion, lane,role, minions, mpm, gold, gpm, kills, assists, deaths, kda, dmg, vision_score, item0 ,item1, item2, item3, item4, item5, trinket, kda_mvp, mvp_kda, kda_mvp_champ, dmg_mvp, mvp_dmg, dmg_mvp_champ)
